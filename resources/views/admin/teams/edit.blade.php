    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="designation" name="designation" required value="{{ old('designation', $team->designation) }}">
            </div>
        </div>
        <div class="col-md-4">
            <div class="mb-3">
                ...
                @if($team->image)
                    <div class="mt-2">
                        <img src="{{ asset($team->image) }}" alt="Current Image" class="img-fluid rounded" style="max-height: 100px;">
                    </div>
                @endif
            </div>
            <div class="mb-3">
